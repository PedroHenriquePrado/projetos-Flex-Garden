...
<body>
  ...
  <section class="sobre" id="sobre">
    ...
    <div class="sobre-img">
      <img src="/imgs/produtos-1.jpg" alt="Plantas da FlexGarden">
    </div>
    <div class="sobre-img">
      <img src="/imgs/produtos-2.jpg" alt="Vasos decorativos">
    </div>
  </section>
  ...
  <section class="produtos" id="produtos">
    ...
    <div class="produtos-container">
      <div class="produtos-item purple">
        <h2>Suculentas</h2>
        <img src="/imgs/produtos-3.jpg" alt="Suculentas">
      </div>
      <div class="produtos-item pink">
        <h2>Samambaias</h2>
        <img src="/imgs/produtos-4.jpg" alt="Samambaia">
      </div>
      <div class="produtos-item blue">
        <h2>Vasos Decorativos</h2>
        <img src="/imgs/produtos-5.jpg" alt="Vasos Decorativos">
      </div>
    </div>
  </section>
